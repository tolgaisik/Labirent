    ...
    Retrive(App labirent) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (name != null) {
                    if (name.charAt(0) == '*')
                        name = name.substring(1);
                    try {
                        BufferedWriter bw = new BufferedWriter(new FileWriter("vs.dat"));
                        bw.write(name);
                        bw.close();
                        listeAl();
        ...
        b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (list.getModel().getSize() < 2) {
                    JOptionPane.showMessageDialog(al, "Tek renk d\u00fczenini silemezsiniz", "Hata",
        ...
        b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                String rename = JOptionPane.showInputDialog(al, "Yeni ismi giriniz", "\u0130sim de\u011fi\u015ftir",
                        JOptionPane.QUESTION_MESSAGE);
                if (rename == null)
                    return;
                if (!new File("ayarlar/" + name).renameTo(new File("ayarlar/" + rename)))
                    JOptionPane.showMessageDialog(al, "\u0130sim de\u011fi\u015ftirilemedi", "Hata",
                            JOptionPane.ERROR_MESSAGE);
                else {
                    if (varsayilan) {
                        try {
